...
@EndOfDesignText@
Sub Class_Globals
	Private const mModule As String = "mnuHeatersTool"' 'ignore
...
private Sub TempsTool_Closed (index As Int, tag As Object)
	...
	Try
		...
		Select Case True
			...
			Case index = 1  '--- tool off
				mainObj.MasterCtrlr.cn.PostRequest(oc.cCMD_SET_TOOL_TEMP.Replace("!VAL0!",0).Replace("!VAL1!",0))
				msg = "Tool Off"
